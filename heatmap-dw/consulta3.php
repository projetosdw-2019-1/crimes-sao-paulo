...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="mx-auto">
                <h1>Crimes por indice populacional e por período do dia</h1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="get" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="ip">Indice Populacional: </label>
                    <select class="form-control" id="ip" name="ip" required>
                        <option value="" selected hidden>--Selecione--</option>
                        <?php 
                        
                            $sql = "SELECT * FROM IndicePopulacional";

                            $stmt = $conn->query($sql);
                            $data = $stmt->fetchAll();

                            foreach ($data as $value) {
                                echo "<option value=".$value['ID_INDICE_POPULACIONAL'].">".$value['LABEL']."</option>";
                            }
                ...
                <div class="form-group">
                    <label for="per">Período do dia: </label>
                    <select class="form-control" id="per" name="per" required>
                        ...
                        <?php 
                            ...
                            foreach ($data as $value) {
                                echo "<option value=".$value['ID_PERIODO'].">".$value['PERIODO']."</option>";
                            }
        ...
        <?php
            if(isset($_GET['anobo']) and isset($_GET['tipo']) and isset($_GET['ip']) and isset($_GET['per'])) {
                ...
                $sql = "SELECT  
                        ...
                        WHERE O.ANO_BO = $ano 
                        AND IP.ID_INDICE_POPULACIONAL = $ip 
                        AND TR.ID_TIPO_RUBRICA = $tipo 
                        AND P.ID_PERIODO = $per
